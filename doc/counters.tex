...
\begin{claim}
  $\text{$k$-\isafety} \land \text{$k$-\iconfluence}
   \implies \text{\iconfluence}$
\end{claim}
\begin{proof}
  \todo{Not super hard.}
\end{proof}
...
\begin{claim}
  State-based proof rule $\implies$ \iconfluence{}.
\end{claim}
\begin{proof}
  \todo{Pretty tough.}
\end{proof}
...
\begin{claim}
  State-based tool proof rule $\implies$ \iconfluence{}.
\end{claim}
\begin{proof}
  \todo{Hard, but similar to the visualized one-is-enough proof.}
\end{proof}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=1.5]
      ...
      \dnode[label=left:$D_{n-1}$]{l3}{0, 1}
      \dnode{l4}{0, 0}
      ...
      \draw[txn] (r3) -- (r4) node[midway, right]{$\denote{c_{k+1}}(D_{k}')$};

      \draw[txn] (l1) -- (l2) node[midway, left]{$\denote{c_1}(D_0')$};
      \draw[txn] (l2) -- (l3) node[midway, left]{
        $\begin{array}{l}
          \denote{c_2}(D_1'), \\
          \ldots, \\
          \denote{c_k}(D_{k-1}'), \\
      ...
      \draw[txn] (l3) -- (l4) node[midway, left]{$\denote{c_{k+1}}(D_{k}')$};
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=1.5]
      \inode[label=above:{$D = D_{c_0} = D_{d_0}$}]{a}{0, 0}
      \inode[label=left:$D_{c_1}$]{l1}{$(a) + (240:1)$}
      \inode[label=left:$D_{c_n}$]{l2}{$(l1) + (240:2)$}
      \inode[label=right:$D_{d_1}$]{r1}{$(a) + (300:1)$}
      \inode[label=right:$D_{d_m}$]{r2}{$(r1) + (300:2)$}
      \dnode{b}{$(l2) + (300:3)$}

      \draw[txn] (a) -- (l1) node[midway, left] {$\denote{c_1}(D_{c_0})$};
      \draw[txn] (a) -- (r1) node[midway, right] {$\denote{d_1}(D_{d_0})$};
      \draw[txn] (l1) -- (l2) node[midway, left] {
        $\begin{array}{l}
          \denote{c_2}(D_{c_1}), \\
          \ldots, \\
          \denote{c_n}(D_{c_{n-1}})
        \end{array}$
      };
      \draw[txn] (r1) -- (r2) node[midway, right] {
        $\begin{array}{l}
          \denote{d_2}(D_{d_1}), \\
          \ldots, \\
          \denote{d_m}(D_{d_{m-1}})
        \end{array}$
      };
      \draw[txn] (l2) -- (b) node[midway, left] {
          $\displaystyle \bigcirc_{i=1}^m \denote{d_i} (D_{d_{i-1}})$
      };
      \draw[txn] (r2) -- (b) node[midway, right] {
        $\displaystyle \bigcirc_{i=1}^n \denote{c_i} (D_{c_{i-1}})$
      };
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=2]
      ...
      \inode[label=above:$D$]{s3a}{2, 1}
      \nnode[]{s3b}{2, 0}
      \inode[label=above:$D'$]{s3c}{3, 1}
      \nnode[]{s3d}{3, 0}
