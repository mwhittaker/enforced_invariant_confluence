...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \node[] (1-isafety) at (0, -2) {1-\isafety};
    \node[] (k-isafety) at (0, -4) {$k$-\isafety};
    \node[] (istrengthstar) at (6, 0) {\istrengthstar};
    ...
    \draw[impl] (0-isafety) -> (istrengthstar);
    \draw[impl] (istrengthstar) -> (iconfluence);
