...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \node[] (isafety) at (0, 0) {\isafety};
    \node[] (ipreservation) at ($(isafety) + (30:3)$) {\ipreservation};
    \node[] (iconfluence) at ($(isafety) + (-30:3)$) {\iconfluence};
    \node[] (k-iconfluence) at ($(iconfluence) + (4, 0)$) {$k$-\iconfluence};
    \node[] (1-iconfluence) at ($(k-iconfluence) + (4, 0)$) {1-\iconfluence};

    \draw[impl] (isafety) -> (ipreservation);
    \draw[impl] (isafety) -> (iconfluence);
...
\begin{figure}[h]
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=2]
      ...
      \inode[label=left:$D_1$]{l2}{0, 3}
      \inode[label=left:$D_{n-1}$]{l3}{0, 1}
      \nnode{l4}{0, 0}
      ...
      \draw[dtxn] (l1) -- (l2) node[midway, left]{$\denote{c_1}(D_0')$};
      \draw[dtxn] (l2) -- (l3) node[midway, left]{
        $\begin{array}{l}
          \denote{c_2}(D_1'), \\
          \ldots, \\
          \denote{c_{n-1}}(D_{n-2}'), \\
      ...
      \draw[dtxn] (l3) -- (l4) node[midway, left]{$\denote{c_n}(D_{n-1}')$};
    \end{tikzpicture}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \begin{tikzpicture}[scale=2]
      ...
      \inode[label=left:$D_{t_1}$]{l1}{$(a) + (240:1.5)$}
      \inode[label=left:$D_{t_n}$]{l2}{$(l1) + (0, -2)$}
      \inode[label=right:$D_{u_1}$]{r1}{$(a) + (300:1.5)$}
      \inode[label=right:$D_{u_m}$]{r2}{$(r1) + (0, -2)$}
      \nnode{b}{$(l2) + (300:1.5)$}
