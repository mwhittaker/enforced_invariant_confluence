...
\begin{elidableproof}
  ...
  \clmref{StateBasedTwoIconfluenceDefs}, $T$ is \Iconfluent{}.
\end{elidableproof}
...
\begin{elidableproof}
  ...
  \clmref{OpBasedTwoIconfluenceDefs}, $T$ is \Iconfluent.
\end{elidableproof}
...
\begin{claim}\clmlabel{Monotonicity}
  ...
  set of transactions. Let $I$ be a \defword{monotonic}: for all $s, s'\in S$,
