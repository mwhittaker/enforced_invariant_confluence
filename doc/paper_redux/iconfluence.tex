...
\todo{Define ``reachable'' states and describe that \Iconfluence{} is
equivalent to saying that reachable states are a subset of invariant satisfying
states.}
\todo{Maybe define Iconfluence to say that the initial state satisfies the
invariant?}
