...
without coordination: RedBlue consistency and Sieve, the homeostasis protocol,
explicit consistency, and token based invariant confluence. We then survey
other bodies of related work.
...
%
In~\cite{li2012making}, Li et al.\ also introduce invariant safety as a
