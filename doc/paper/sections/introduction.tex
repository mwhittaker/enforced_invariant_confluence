...
data with strong consistency using a technique like distributed transactions~\cite{bernstein1981concurrency,mohan1986transaction} or state machine
...
invariants~\cite{hoare1969axiomatic, balegas2015towards} and integrity constraints~\cite{IntegrityConstraintCitations}. Even if every
...
approaches instead develop a decision procedure for \emph{\invariantclosure{}}, a
