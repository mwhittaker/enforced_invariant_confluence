...
\begin{benchmark}\benchlabel{VaryWithdraws}
  ...
  The results are shown in the top of \figref{ThroughputVsGlobalSyncs}.
...
\begin{benchmark}
  ...
  \invariantconfluent{} replication. We repeat \benchref{VaryWithdraws} with a
  ...
  The results are shown in \figref{VaryNodes}.
