...
\begin{example}\examplelabel{CounreachableExample}
  ...
  \ticoreachable{T^+}{I} \jmh{Clarify here how the user recognizes this ... I believe that you're saying that the definition of $\Sigma$ implies that decrement requires coordination hence $n_i$ are kept consistent hence disagreeing $n_i$ isn't possible.} The user refines $NR$ with the observation that two
