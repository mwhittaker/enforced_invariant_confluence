...
every $T_i$ is a subset of $T$. $O$ is \defword{segmented \invariantconfluent{}}
...
\begin{algorithm}[t]
  \caption{Transaction execution in segmented \invariantconfluence{} system model}%
...
\defword{$\TIcoreachablepredicate{s_1, s_2}$}, if there exists some state $s_0 \in I$
