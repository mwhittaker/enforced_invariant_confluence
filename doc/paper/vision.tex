...
\begin{todoitemize}
  \item \todo{Cite and summarize \cite{balegas2015putting},
    \cite{roy2015homeostasis}, \cite{li2012making}, \cite{li2014automating},
    and \cite{gotsman2016cause}.}
  \item \todo{Consider creating a related works section.}
\end{todoitemize}
