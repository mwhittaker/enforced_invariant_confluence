...
\begin{figure*}[ht]
  ...
  \caption{%\vspace{1em}
    ...
    \algoref{InteractiveDecisionProcedure} on \exampleref{Z2}.  Each step
    of the visualization shows Reachable states $R$ (left), non-Reachable states $NR$ (middle), and the refined invariant $I - NR$ (right) as the
    algorithm executes.
  }
