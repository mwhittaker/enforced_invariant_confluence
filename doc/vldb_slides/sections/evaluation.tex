...
\begin{frame}
  ...
  \note{%
    ...
    allows a smooth tradeoff between the two.

    % Fully invariant confluent objects don't require any coordination, partly
    % invariant confluent objects require some coordination, and not at all
    % invariant confluent objects require a lot of coordination.
  }
\end{frame}

\begin{frame}
  \includegraphics[width=\textwidth]{assets/throughput_vs_num_nodes_multi.pdf}
\end{frame}
...
\begin{frame}
  ...
  \note{%
    ...
    come to our poster tomorrow night where I'm happy to chat. \\[12pt]

    With that, I'll conclude. Thank you all for listening, and I'm happy to
    take questions. \\[12pt]
  }
\end{frame}
