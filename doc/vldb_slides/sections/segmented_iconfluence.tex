...
\begin{frame}
  ...
  \note{%
    This is not ideal. Ideally, invariant confluent objects can use weak
    consistency. Objects that are kinda invariant confluent can use weakish
    consistency, and objects that are not at all invariant confluent can use
    strong consistency. We should have a spectrum of coordination to match our
    spectrum of invariant confluence-ness.
  }
\end{frame}
...
\begin{frame}
  ...
  \note{%
    ...
    the second quadrant, the fourth quadrant, the y-axis and the x-axis. I
    encourage you to read the paper for more details.
  }
\end{frame}
