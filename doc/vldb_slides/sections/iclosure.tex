...
\begin{frame}
  ...
  \note{%
    ...
    % Why is that? Well for an object to be invariant confluent, every reachable
...
\begin{frame}
  ...
  \note{%
    ...
    % This is not something we can do with invariant confluence because it's hard
    % to express reachability as a simple formula like this one.
  }
\end{frame}
...
\begin{frame}
  ...
  \note{%
    ...
    Again, I'll refer you to the paper for a proof.
