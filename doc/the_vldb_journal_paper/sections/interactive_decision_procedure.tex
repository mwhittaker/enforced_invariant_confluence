...
(e.g., $s_1$ and $s_2$ from \exampleref{Z2}).  As we mentioned earlier, we can
...
$R$ and $NR$ are correct).  As \algoref{InteractiveDecisionProcedure} executes,
