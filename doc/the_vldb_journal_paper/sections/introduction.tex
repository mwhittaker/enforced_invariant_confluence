...
object is \invariantconfluent{} with respect to an \markrevisions{accompanying}
invariant, we can replicate the \markrevisions{object and invariant} with the
...
In closing, here is a summary of our contributions:
\begin{itemize}
  \item
