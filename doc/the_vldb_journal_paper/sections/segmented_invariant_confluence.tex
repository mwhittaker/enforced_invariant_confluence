...
\begin{example}
  ...
  $16$ are \TIcoreachable{} because both are \stireachable{s}{T}{I} from $s =
...
\begin{example}\examplelabel{CounreachableExample}
  ...
  \algoref{InteractiveDecisionProcedure} returns false.
  \begin{revisions}
  ...
  \end{revisions}
  Applying, \algoref{ArbitraryStartInteractiveDecisionProcedure},
...
\subsection{Discussion and Limitations}~\seclabel{SegmentedDiscussion}
...
case, a round of global coordination is avoided. \markrevisions{Later, in
\exampleref{EscrowTransactionsEval}, we'll see a concrete example of this
optimization.}
%
