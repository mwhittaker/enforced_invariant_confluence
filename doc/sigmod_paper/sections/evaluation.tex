...
linearizability.
% With eventual consistency, clients send every transaction
...
% We begin by demonstrating the decision procedure on a handful of
...
% \begin{benchmark}
  ...
  that are decrements.  The results are shown in \figref{VaryNodes}.
