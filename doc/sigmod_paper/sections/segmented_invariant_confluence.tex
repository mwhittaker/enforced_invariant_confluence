...
of coordination.
% In \secref{Evaluation}, we see that replicating a non-\invariantconfluent{}
% object with segmented \invariantconfluence{} can achieve between 10x and 100x
% more throughput than linearizable replication for certain workloads.
