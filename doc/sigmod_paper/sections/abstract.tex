...
%
% foreign keys, rollups, escrow transactions, and more.
foreign keys, escrow transactions, and more.
%
We also found that segmented \invariantconfluent{} replication can deliver up
to an order of magnitude more throughput than linearizable replication.
% for low contention workloads and comparable throughput for medium to high
