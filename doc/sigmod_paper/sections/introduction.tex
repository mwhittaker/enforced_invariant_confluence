...
no workload requires more than 66 lines of code to specify.
% Moreover, we find that segmented \invariantconfluent{} replication can achieve
% 10x to 100x more throughput than linearizable replication for low-coordination
% workloads.
