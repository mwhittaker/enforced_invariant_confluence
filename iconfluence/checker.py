...
from . import ast
from .envs import CrdtEnv, TypeEnv, ExprEnv
...
class Checker:
    def __init__(self):
        ...
        self.start_state_env: ExprEnv = dict()
    ...
    def _register_var(self,
        ...
        assert name not in self.start_state_env, (name, self.start_state_env)
